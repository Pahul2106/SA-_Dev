...
import implemens.GrapheHHAdj;
import implemens.GrapheLAdj;
import implemens.GrapheLArcs;
import implemens.GrapheMAdj;

class IGrapheTest {
	private final core.IGraphe[] graphes = {
	...
	void petiteImporation(IGraphe g, String filename) {
		...
		System.out.println(filename+ " : "+ g.toAString());
		assertEquals("1-3(5), "
